...
my_dataset1 = GeneaDatasetBVHLoader(name='tst', 
                                    ...
                                    pos_mean = './Dataset/Genea2023/trn/bvh/report/trn_bvh_positions_mean.npy',  # Archivo mean para poses 3D
                                    pos_std = './Dataset/Genea2023/trn/bvh/report/trn_bvh_positions_std.npy',
                                    rot3d_mean = './Dataset/Genea2023/trn/bvh/report/trn_bvh_3drotations_mean.npy',
                                    rot3d_std = './Dataset/Genea2023/trn/bvh/report/trn_bvh_3drotations_std.npy',
                                    step=10, 
                                    window=90)
...
for index1, item in enumerate(directories):
    if os.path.isdir(os.path.join(path_1, item)):
        ...
        my_dataset2 = GeneaDatasetBVHLoader(name=f'{item}', 
                                            path=f'{path_1}{item}', 
                                            load=False,  
                                            pos_mean = './Dataset/Genea2023/trn/bvh/report/trn_bvh_positions_mean.npy',
                                            pos_std = './Dataset/Genea2023/trn/bvh/report/trn_bvh_positions_std.npy',
                                            rot3d_mean = './Dataset/Genea2023/trn/bvh/report/trn_bvh_3drotations_mean.npy',
                                            rot3d_std = './Dataset/Genea2023/trn/bvh/report/trn_bvh_3drotations_std.npy',
                                            step=10, 
