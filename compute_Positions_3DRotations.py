...
my_dataset = GeneaDatasetBVHLoader(name='trn', 
                                   ...
                                   pos_mean = './TWH_dataset/trn/bvh/report/trn_bvh_positions_mean.npy', # Arquivos mean e std para poses 3D e rotações 3D
                                   pos_std = './TWH_dataset/trn/bvh/report/trn_bvh_positions_std.npy',
                                   rot3d_mean = './TWH_dataset/trn/bvh/report/trn_bvh_3drotations_mean.npy',
                                   rot3d_std = './TWH_dataset/trn/bvh/report/trn_bvh_3drotations_std.npy',
                                   step=10, 
                                   window=90)
...
def trainFGD(trn_loader):
    for epoch in range(50):
        ...
        save_name = f'./evaluation_metric/output_2/model_checkpoint_epoch_{epoch}_{trn_loader.dataset.window}_{pose_dim}_2.bin'
